...
public class RoomManager
{
    ...
    public void StartRoom(Room room)
    {
        ...
        JobScheduler jobScheduler = new JobScheduler(TimeSpan.FromSeconds(1.0/60.0));
    ...
    public void UpdatePlayerPositionAndRotation(Guid playerId, Vector3 position, Quaternion rotation)
    {
        ...
        _playerPositions[new KeyValuePair<Guid, Guid>(roomId, playerId)] = new KeyValuePair<Vector3, Quaternion>(position, rotation);
    }
    ...
    public void FinishPlayer(Guid playerId)
    {
        ...
        _playerFinishStatuses[new KeyValuePair<Guid, Guid>(roomId, playerId)] = new KeyValuePair<DateTime, bool>(DateTime.Now, true);
    }
